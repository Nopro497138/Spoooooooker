      ...
      <>
        ...
        <main className="container">
          <div className="card center" style={{padding:28}}>
            <h2 style={{color:'var(--accent)'}}>Sign in to access Planko</h2>
            <p className="small">You must be logged in with Discord or email to play.</p>
          </div>
        </main>
      </>
    )
  ...
  return (
    <>
      ...
      <div className="container" style={{paddingTop:20}}>
        <div className="card">
          <h2>Planko</h2>
          <p className="small">Drop the ball and land on a multiplier.</p>
